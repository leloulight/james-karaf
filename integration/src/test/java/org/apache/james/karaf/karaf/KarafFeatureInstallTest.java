...
public class KarafFeatureInstallTest {
  ...
  public static Option[] configuration() throws Exception {
    ...
    String jamesFeaturesVersion = MavenUtils.getArtifactVersion("org.apache.james", "james-features");
    ...
    return new Option[]{
        ...
        systemProperty("james-features").value(jamesFeaturesVersion)
    };
  }

  @Before
  public void setUp() {
    featuresVersion = System.getProperty("james-features");
  }

  @Test
  public void shouldInstallAllFeatures() throws Exception {
    String url = maven("org.apache.james", "james-features")
